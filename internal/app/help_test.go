...
func TestLeafHelpFlags(t *testing.T) {
	leaves := []struct {
		...
		{"pr view --help", []string{"pr", "view", "--help"}, "--id"},
		{"pr edit --help", []string{"pr", "edit", "--help"}, "--title"},
		{"pr approve --help", []string{"pr", "approve", "--help"}, "--id"},
		{"pr decline --help", []string{"pr", "decline", "--help"}, "--id"},
		{"pr comment --help", []string{"pr", "comment", "--help"}, "--body"},
		{"pr diff --help", []string{"pr", "diff", "--help"}, "--id"},
		{"pr statuses --help", []string{"pr", "statuses", "--help"}, "--id"},
		{"pr unapprove --help", []string{"pr", "unapprove", "--help"}, "--id"},
		{"pr request-changes --help", []string{"pr", "request-changes", "--help"}, "--id"},
		{"pr checkout --help", []string{"pr", "checkout", "--help"}, "--id"},
		{"pr activity --help", []string{"pr", "activity", "--help"}, "--id"},
		{"pr comments --help", []string{"pr", "comments", "--help"}, "--id"},
...
func TestHelpOutputUsesDoubleDash(t *testing.T) {
	leaves := []struct {
		...
		{"pr view", []string{"pr", "view", "--help"}},
		{"pr edit", []string{"pr", "edit", "--help"}},
		{"pr approve", []string{"pr", "approve", "--help"}},
		{"pr decline", []string{"pr", "decline", "--help"}},
		{"pr comment", []string{"pr", "comment", "--help"}},
		{"pr diff", []string{"pr", "diff", "--help"}},
		{"pr statuses", []string{"pr", "statuses", "--help"}},
		{"pr unapprove", []string{"pr", "unapprove", "--help"}},
		{"pr request-changes", []string{"pr", "request-changes", "--help"}},
		{"pr checkout", []string{"pr", "checkout", "--help"}},
		{"pr activity", []string{"pr", "activity", "--help"}},
		{"pr comments", []string{"pr", "comments", "--help"}},
